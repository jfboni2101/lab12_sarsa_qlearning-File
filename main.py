...
if __name__ == '__main__':
    ...
    if args.mode == 'qlearn':
        agent = QLearnAgent(n_rows=args.n_rows, n_cols=args.n_cols, epsilon=args.epsilon, alpha=args.alpha,
                            gamma=args.gamma)
    elif args.mode == 'sarsa':
        agent = SarsaAgent(n_rows=args.n_rows, n_cols=args.n_cols, epsilon=args.epsilon, alpha=args.alpha,
                           gamma=args.gamma)
